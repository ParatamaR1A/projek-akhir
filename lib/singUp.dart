...
class SignUp_layar extends StatefulWidget{
  final VoidCallback show;
  SignUp_layar(this.show,{super.key});
  
  @override
  State<SignUp_layar> createState() => _SignUp_layarState();
}

class _SignUp_layarState extends State<SignUp_layar> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 10,),
            teksdaerah(PasswordConfirm, _focusNode3,'Password Confirm',Icons.password),
            SizedBox(height: 8,),
            akun(),
            SizedBox(height: 20,),
            SingUp_Bawah()
